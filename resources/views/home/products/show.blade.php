                        ...
                        @if ($product->quantity_check)
                            ...
                            <div class="pro-details-quality">
                                ...
                                <div class="pro-details-compare">
                                    <a href="{{ route('home.compare.add', ['product' => $product->id]) }}"><i class="sli sli-refresh"></i></a>
                                </div>
                            </div>
                        @else
                            <div class="not-in-stock">
                                    ...
                                    @foreach ($product->approvedComments as $comment)
                                        <div class="single-review">
                                            <div class="review-img">
                                                <img src="{{ $comment->user->avatar ? $comment->user->avatar : asset('/images/home/user.png') }}"
                                                    alt="">
                                            </div>
                                            <div class="review-content w-100 text-right">
                                                ...
                                                <div class="review-top-wrap">
                                                    <div class="review-name">
                                                        <h4> {{ $comment->user->name ? $comment->user->name : 'کاربر گرامی' }}
                                                        </h4>
                                                    </div>
                                                    <div data-rating-stars="5" data-rating-readonly="true"
